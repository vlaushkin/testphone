...
public class AccountMediaConfig extends PersistentObject {
  ...
  public void setRtcpMuxEnabled(SWIGTYPE_p_pj_bool_t value) {
    pjsua2JNI.AccountMediaConfig_rtcpMuxEnabled_set(swigCPtr, this, SWIGTYPE_p_pj_bool_t.getCPtr(value));
  }

  public SWIGTYPE_p_pj_bool_t getRtcpMuxEnabled() {
    return new SWIGTYPE_p_pj_bool_t(pjsua2JNI.AccountMediaConfig_rtcpMuxEnabled_get(swigCPtr, this), true);
  }
